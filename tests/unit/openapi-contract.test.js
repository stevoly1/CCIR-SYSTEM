...
const EXPECTED_OPERATIONS = [
  ...
  'GET /users', 'GET /users/assignable', 'GET /users/profile', 'PATCH /users/profile', 'DELETE /users/profile', 'POST /users/profile/password', 'POST /users/logout', 'PATCH /users/{id}', 'DELETE /users/{id}',
